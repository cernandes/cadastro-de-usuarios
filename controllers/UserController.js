...
class UserController {
    ...
    /*edição de um usuário cadastrado */
    onEdit() {
    ...
    /*listar os campos do formulário */
    getValues(formEl) {
        let user = {};
        let isValid = true;
    ...
    /*geração dinâmica da tabela no corpo do documento */
    addLine(dataUser) {
    ...
    getTr(dataUser, tr = null) {
        ...
        tr.innerHTML = `<td><img src="${dataUser.photo}" alt="User Image" class="img-circle img-sm"></td>
                        ...
                        <td>${Utility.dateFormat(dataUser.register)}</td>
                        <td>
    ...
    /*mostrar painel de criação de novos usuários */
    showPanelCreate() {
        document.querySelector("#box-user-create").style.display = "block";
        document.querySelector("#box-user-update").style.display = "none";
    }

    /*mostrar painel de edição de novos usuários */
    showPanelUpdate() {
    ...
    showMenu() {
        ...
        document.querySelector(".usersMenu").addEventListener("click", e => {
